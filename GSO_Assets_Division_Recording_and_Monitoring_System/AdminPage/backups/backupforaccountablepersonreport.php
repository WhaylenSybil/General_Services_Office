...
<head>
    ...
    <?php
           ...
           if (isset($_GET['accountablePerson'])) {
               ...
               echo "<title style='text-align: center;'>Report on Physical Count Of Property, Plant and Equipment<br>Accountable Employee: $accountablePerson</title>";
           } else {
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // Create the "Show Additional Details" button
                ...
                // Create the "Show Additional Details" button
                var showDetailsButton = $('<button class="btn btn-show-details dt-button buttons-html5" onclick="toggleAdditionalDetails()" id="toggleAdditionalDetails">Hide Additional Details</button>');
            ...
            // Create the 'Show/Hide Date Recorded' button
                var showDateRecordedButton = $('<button class="btn btn-show-details dt-button buttons-html5" onclick="toggleDateRecorded()" id="toggleDateRecorded">Hide Date Recorded</button>');
