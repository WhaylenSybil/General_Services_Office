            ...
            <section class="content container-fluid">
                <div class="box">
                    ...
                    <form method="POST" action="" enctype="multipart/form-data" id="AddNewICSregistry">
                        <div class="box-body">
                            <div class="row">
                                <?php include("./addNewICS.php") ?>
                                <?php include("./ICSaddAdditionalDetails.php") ?>
                                <?php include("./ICSreconciliation.php") ?>
                                
                                <!-- ARE Registry Button -->
                                <div class="col-md-12">
                                    <div class="form-group" align="center">
                                        <button type="button" class="btn btn-primary" name="saveICS" id="saveICS">SAVE ICS</button>
                                    </div>
                                </div>
                            </div><!-- row -->
                        </div><!-- box-body -->
