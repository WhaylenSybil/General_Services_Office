...
include('../AdminPage/includes/editInactivePPE.php');
?>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header"><br>
        <h1>UPDATE ACKNOWLEDGEMENT RECEIPT FOR EQUIPMENT (ARE) REGISTRY
        </h1>
      ...
      <section class="content container-fluid">
        <div class="box">
          <div class="box-header bg-blue" align="center">
            <h4 class="box-title">UPDATE ARE-ISSUED PROPERTY, PLANT AND EQUIPMENT</h4><br>
          </div><!-- <div class="box-header bg-blue" align="center"> -->

        <!-- Container Fluid for the Registry Form -->
        <form method="POST" enctype="multipart/form-data" id="editAREform" name="editAREform">
          <div class="box-body">
            <div class="row">

              <?php include ("./editARE1.php") ?>
              <?php include ("./editARE2.php") ?>
              <?php include ("./editARE3.php") ?>
            
              <!-- ARE Registry Button -->
              <div class="col-md-12">
                <div class="form-group" align="center">
                  <button type="submit" class="btn btn-success" name="btn_updateARE" id="btn_updateARE">UPDATE ARE</button>
                </div>
              </div>
            </div><!-- row -->
  ...
  <script>
    function validateUnitValue(input) {
        ...
        if (isNaN(floatValue) || floatValue < 50000) {
            ...
            document.getElementById('errorMessage').innerText = " Please enter unit value that is 50,000.00 or higher";
