...
*/
        ...
        if (isset($_GET['dateYear'])) {
            ...
            echo "<title>Report on Physical Count Of Semi-Expendable Property, Plant and Equipment\nYear: $year</title>";
        }
    ?>
        ...
        if (isset($_GET['dateYear'])) {
            ...
            if ($stmt) {
                ...
                if ($result->num_rows > 0) {
                    echo "<h3 id='printTitle' style='text-align: center; line-height: 2em;'>Report on Physical Count of Semi-Expendable Property, Plant, and Equipment<br>Year: <span style='text-decoration: underline;'>$dateYear</span><br> (Type of Property, Plant, and Equipment) </h3>";
                    ...
                    while ($row = $result->fetch_assoc()) {
                         echo '
                            <tr>
                                ...
                                <td style="white-space: nowrap;">' . $row['ICSno'] . '</td>
                                <td>' . $row['eNGAS'] . '</td>
                    ...
                    echo "No ICS properties found for Year: $dateYear";
                }
