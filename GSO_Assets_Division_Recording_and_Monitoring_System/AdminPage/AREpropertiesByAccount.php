...
<head>
    ...
    <?php
           ...
           if (isset($_GET['accountNumber'])) {
               ...
               echo "<title style='text-align: center;'>Office/Department: $account</title>";
           } else {
    ...
    <style>
        ...
        #AREperAccountTable th{
            text-align: center;
        }
        #AREperAccountTable td{
            text-align: center;
        }
        @media print{
            $AREperAccountTable th{
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#AREperAccountTable').DataTable({
                dom: 'Bfrtip',
                buttons: [
                    {
                        extend: 'print',
    ...
    if (isset($_GET['accountNumber'])) {
        ...
        if ($stmt) {
            ...
            if ($result->num_rows > 0) {
                echo "<h3 id='printTitle' style='text-align: center; line-height: 2em;'>Report on Physical Count of Property, Plant, and Equipment<br>Account: <span style='text-decoration: underline;'>$account</span></h3>";

                // Display the table
                echo "<div class = 'table-responsive'>";
                echo "<div style ='max-height:200%; overflow-y:auto;'>";
                echo "<table id='AREperAccountTable' class='table table-bordered table-striped'>";
                echo "<thead>
                        <tr>
                ...
                echo "No ARE properties found for Account: $account";
            }
