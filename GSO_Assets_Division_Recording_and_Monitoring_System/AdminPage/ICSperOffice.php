  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1><i class="fa fa archive"></i>ICS Per Office/Department Report</h1>
        <ol class="breadcrumb">
          <li><a href="AREreports.php"><i class="fa fa-dashboard">ICS per Office/Department Report</i></a></li>
        </ol>
      </section>
      ...
      <section class="content container-fluid">
        <div class="box box-primary">
          <div class=" box-header bg-blue text-center">
            <h4 class="box-title">ICS per Office/Department Report</h4>
          </div>
          <div class="box-body">
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-12">
                    <?php foreach ($OfficeArray as $office) : ?>
                       <div class="col-md-4 office-box">
                         <a href="ICSpropertiesByOffice.php?officeName=<?php echo urlencode($office['officeName']); ?>" class="box-link" target="_blank">
