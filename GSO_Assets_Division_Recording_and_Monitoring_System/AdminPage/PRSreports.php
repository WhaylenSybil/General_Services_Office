  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1><i class="fa fa archive"></i>Property Return Slip (PRS) Reports</h1>
        <ol class="breadcrumb">
          <li><a href="dashboard.php"><i class="fa fa-dashboard">PRS Reports</i></a></li>
        </ol>
      </section>
      ...
      <section class="content container-fluid">
        <div class="box">
          <div class=" box-header bg-blue">
            <h4 class="box-title"><!-- ACKNOWLEDGEMENT FOR RECEIPT OF EQUIPMENT(PRS) PRINTABLE REPORTS --></h4>
          </div>
          <div class="box-body">
            <div class="row">
              <a href="PRSperAccountablePerson.php">
                <div class="col-md-4 col-sm-6 col-sx-12">
                  <div class="info-box">
                    ...
                    <div class="info-box-content">
                      ...
                      <a href="PRSperAccountablePerson.php" class="small-box-footer"></a>
                    </div><!-- info-box-content -->
                  </div><!-- info-box -->
                </div><!-- col-md-4 col-sm-6 col-sx-12 -->
              </a>

              <a href="PRSperYear.php">
                <div class="col-md-4 col-sm-6 col-sx-12">
                  <div class="info-box">
                    <span class="info-box-icon bg-purple"><i class="fa fa-print"></i></span>
                    <div class="info-box-content">
                      <span class="info-box-number"> PER YEAR</span>
                      <a href="PRSperYear.php" class="small-box-footer"></a>
                    </div><!-- info-box-content -->
                  </div><!-- info-box -->
                </div><!-- col-md-4 col-sm-6 col-sx-12 -->
              </a>

              <a href="PRSperOffice.php">
                <div class="col-md-4 col-sm-6 col-sx-12">
                  <div class="info-box">
                    <span class="info-box-icon bg-purple"><i class="fa fa-print"></i></span>
                    <div class="info-box-content">
                      <span class="info-box-number"> PER OFFICE/DEPARTMENT</span>
                      <a href="PRSperOffice.php" class="small-box-footer"></a>
                    </div><!-- info-box-content -->
                  </div><!-- info-box -->
                </div><!-- col-md-4 col-sm-6 col-sx-12 -->
              </a>

              <a href="PRSperAccountCode.php">
                <div class="col-md-4 col-sm-6 col-sx-12">
                  <div class="info-box">
                    <span class="info-box-icon bg-purple"><i class="fa fa-print"></i></span>
                    <div class="info-box-content">
                      <span class="info-box-number"> PER ACCOUNT CODE</span>
                      <a href="PRSperAccountCode.php" class="small-box-footer"></a>
                    </div><!-- info-box-content -->
                  </div><!-- info-box -->
                </div><!-- col-md-4 col-sm-6 col-sx-12 -->
              </a>
