...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        $prsaccountablePerson = $row['accountablePerson'];
        // Skip empty accountable person names
        if (!empty($prsaccountablePerson)) {
            ...
            $prsAccountablePersonArray[] = ['accountablePerson' => $prsaccountablePerson, 'colorClass' => $randomColorClass];
        }
    }
}

    //Sort the $prsAccountablePersonArray alphabetically by the accountablePerson field
    usort($prsAccountablePersonArray, function($a, $b){
      ...
      <section class="content container-fluid">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <?php foreach ($prsAccountablePersonArray as $prsaccountablePerson) : ?>
                        <div class="col-md-3 employee-box">
                            <a href="PRSpropertiesByAccountablePerson.php?accountablePerson=<?php echo urlencode($prsaccountablePerson['accountablePerson']); ?>" class="box-link" target="_blank">
                                <div class="small-box <?php echo $prsaccountablePerson['colorClass']; ?>">
                                    <div class="inner">
                                        <h4 class="employee-name" align="center"><?php echo $prsaccountablePerson['accountablePerson']; ?></h4>
                                    </div>
                                </div>
                            </a>
                        </div>
