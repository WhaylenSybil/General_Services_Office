...
<div class="col-md-12"><!-- Group 1 -->
  <div class="form-group">
    <h4 class="box-title" align="center"><b>REGISTRY OF NEW ICS-ISSUED PPE</b></h4>
    <div class="horizontal-line"></div>
  </div>
</div>
<!-- End of NEW ICS REGISTRY -->
...
<div class="col-md-3">
  <div class="form-group">
    ...
    <input type="date" class="form-control" id="dateReceived" placeholder="Date Received" name="dateReceived" autocomplete="off" required max="<?php echo date('Y-m-d'); ?>" value="<?php echo date('Y-m-d'); ?>" required>
  </div>
</div>
<!-- End Date Recorded -->
...
<div class="col-md-12">
  <table class="table table-bordered" id="dynamicFields2">
    <thead>
      <tr>
    ...
    <tbody>
      <tr>
        ...
        <td><input type="text" class="form-control" name="ICSno[]" autocomplete="off"></td>
