...
<body class="hold-transition skin-blue sidebar-mini fixed">
  <div class="wrapper">
            ...
            <div class="box">
              ...
              <div class="table-responsive">
                <table id="inactivePPE" class="table table-hover responsive" cellpadding="0" width="100%">
                  <thead>
                    ...
                    <tr>
                      ...
                      <th class="subcolumn" style="white-space: nowrap; text-align: center;">
                          <span style="text-align: center;">PARTICULARS</span>
                      </th>
                  ...
                  <tbody>
                    <?php include("../AdminPage/manageInactivePPEtable.php")?>
                  </tbody>
                </table>
    ...
    <script src="https://cdn.datatables.net/select/2.0.0/css/select.dataTables.css"></script>
    <script src="https://cdn.datatables.net/datetime/1.5.2/css/dataTables.dateTime.min.css"></script>
    <script src="https://editor.datatables.net/extensions/Editor/css/editor.dataTables.css"></script>
    ...
    <script>
      $(document).ready(function() {
          ...
          // Enable cell editing
          var myTable = $('#inactivePPE').DataTable();
          $('#activePPE').on('click', 'tbody td', function() {
