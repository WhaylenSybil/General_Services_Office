    ...
    <div class="content-wrapper">
      ...
      <section class="content container-fluid">
        <div class="btn-group">
            ...
            <form enctype="multipart/form-data" method="POST" action="importPRSdata.php" style="display: inline-block; margin-left: 90px;">
                <input type="file" name="file" id="file" accept=".xlsx, .xls" style="display: inline-block;">
                <button type="submit" name="importPRS" class="btn btn-primary" id="importPRS" style="display: inline-block;">IMPORT</button>
            </form>    
        </div><br>
                ...
                <table id="PRS" class="table table-hover responsive" cellpadding="0" width="100%">
                  <thead>
                    <tr>
                      ...
                      <th rowspan="2" style="text-align: center;">ATTACHMENT</th>
                      <th rowspan="2" style="text-align: center;">COVER PAGE</th>
                      <th rowspan="2" style="text-align: center; white-space: nowrap;">IIRUP #</th>
                    ...
                    <tr>
                      ...
                      <th class="subcolumn" style="white-space: nowrap; text-align: center;">ARE NUMBER</th>
                      <!-- <th class="subcolumn" style="text-align: center;">(Qty)</th> -->
                      <!-- <th class="subcolumn" style="text-align: center;">(Qty)</th> -->
                      <!-- <th class="subcolumn" style="text-align: center;">(Qty)</th>
                      <th class="subcolumn" style="text-align: center;">Value</th> -->
                      <th class="subcolumn" style="white-space: nowrap; text-align: center;">MODE OF DISPOSITION</th>
