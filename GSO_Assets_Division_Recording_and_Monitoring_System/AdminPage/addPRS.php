      ...
      <section class="content container-fluid">
        <div class="box">
          ...
          <form method="post" action="" enctype="multipart/form-data" id="addPRSform">
            <div class="row-flex">
              <?php include_once("./../AdminPage/prsParts/group1.php"); ?>
              <?php include_once("./../AdminPage/prsParts/group2.php"); ?>
              <?php include_once("./../AdminPage/prsParts/group3.php"); ?>
              <?php include_once("./../AdminPage/prsParts/group4.php"); ?>
              <?php include_once("./../AdminPage/prsParts/group5.php"); ?>

            </div><!-- row-flex -->

            <!-- Add ARE Registry Save button -->
            <div class="form-group" align="center" >
              <button type="button" class="btn btn-primary" name="savePRS" id="savePRS">Add PRS</button><br><br>
            </div>
          </form><!-- addPRSform -->     
        </div><!-- div-box -->
      </section>
