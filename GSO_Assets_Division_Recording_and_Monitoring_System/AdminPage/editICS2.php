...
<div class="col-md-6">
  <div class="form-group">
    ...
    <textarea type="text" class="form-control" id="airemarks" placeholder="Remarks" autocomplete="off"  name="airemarks" style="resize: vertical; height: 2.4em;"><?php echo $row['gpremarks']; ?></textarea>
  </div>
</div>
