  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1><i class="fa fa archive"></i>ICS Accountable Employees</h1>
        <ol class="breadcrumb">
          <li><a href="ICSreports.php"><i class="fa fa-dashboard">ICS Accountable Employees</i></a></li>
        </ol>
      </section>
      ...
      <section class="content container-fluid">
        <div class="box">
          <div class=" box-header bg-blue text-center">
            <h4 class="box-title">ICS ACCOUNTABLE EMPLOYEES</h4>
          </div>
          <div class="box-body">
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-12">
                    <?php foreach ($AccountablePersonArray as $accountablePerson) : ?>
                        <div class="col-md-3 employee-box">
                            <a href="ICSpropertiesByAccountablePerson.php?accountablePerson=<?php echo urlencode($accountablePerson['accountablePerson']); ?>" class="box-link" target="_blank">
