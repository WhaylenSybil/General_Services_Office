...
$sql = "SELECT DISTINCT
            YEAR(agp.dateReceived) AS ICSyear
        FROM
            are_ics_gen_properties agp
        LEFT JOIN
            ics_properties ip ON agp.propertyID = ip.propertyID
        WHERE
            ip.propertyID IS NOT NULL";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        $year = $row['ICSyear']; // Use 'year' alias instead of 'date_recorded'
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1><i class="fa fa archive"></i>Per Year ICS Report</h1>
        <ol class="breadcrumb">
          <li><a href="ICSreports.php"><i class="fa fa-dashboard">ICS per Year Report</i></a></li>
        </ol>
      </section>
      ...
      <section class="content container-fluid">
        <div class="box box-primary">
          <div class=" box-header bg-blue text-center">
            <h4 class="box-title">ICS per Year Report</h4>
          </div>
          <div class="box-body">
            <div class="row">
                <div class="col-md-12">
                    <?php foreach ($YearArray as $dateYear) : ?>
                       <div class="col-md-4">
                         <a href="ICSpropertiesByYear.php?dateYear=<?php echo urlencode($dateYear['dateYear']); ?>" class="box-link" target="_blank">
