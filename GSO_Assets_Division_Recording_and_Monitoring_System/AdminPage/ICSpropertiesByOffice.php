...
<head>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#ICSperYearTable').DataTable({
                dom: 'Bfrtip',
                buttons: [
                    {
                        extend: 'print',
...
<body>
    ...
    if (isset($_GET['officeName'])) {
        ...
        $sql = "SELECT ip.*, gp.*, agp.*, ac.accountNumber AS classification,
                ...
                INNER JOIN generalproperties ics_gp ON ics_gp.propertyID = ip.propertyID
                WHERE gp.officeName = ?";
        ...
        if ($stmt) {
            ...
            if ($result->num_rows > 0) {
                echo "<h3 id='printTitle' style='text-align: center; line-height: 2em;'>Report on Physical Count of Semi-Expendable Property, Plant, and Equipment<br>Office/Department: <span style='text-decoration: underline;'>$officeName</span></h3>";

                // Display the table
                echo "<div class = 'table-responsive'>";
                echo "<div style ='max-height:200%; overflow-y:auto;'>";
                echo "<table id='ICSperYearTable' class='table table-bordered table-striped'>";
                echo "<thead>
                        <tr>
                ...
                echo "No ICS properties found for Office/Department: $officeName";
            }
        ...
        echo "Office parameter not provided.";
    }
    ?>
    </div>
</body>
