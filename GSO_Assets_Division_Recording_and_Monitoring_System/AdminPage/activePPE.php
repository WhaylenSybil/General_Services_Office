  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper"><br>
      ...
      <section class="content container-fluid">
        <div class="btn-group">
            <a href="ARE_registry.php" class="btn btn-primary"><i class="fa fa-fw fa-plus"></i>&nbsp; Add ARE Registry</a>
            <form enctype="multipart/form-data" method="POST" action="importAREdata.php" style="display: inline-block; margin-left: 90px;">
                <input type="file" name="file" id="file" accept=".xlsx, .xls" style="display: inline-block;">
                <button type="submit" name="importARE" class="btn btn-primary" id="importARE" style="display: inline-block;">IMPORT</button>
            </form>
        </div>
            ...
            <div class="box">
              ...
              <div class="table-responsive">
                <table id="activePPE" class="table table-hover responsive" cellpadding="0" width="100%">
                  ...
                  <tbody>
                    <?php include("../AdminPage/manageActivePPEtable.php")?>
                  </tbody>
                </table>
