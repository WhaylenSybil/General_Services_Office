    ...
    if (isset($_FILES['file']['tmp_name']) && !empty($_FILES['file']['tmp_name'])) {
        ...
        if ($file_ext === 'xlsx' || $file_ext === 'xls') {
            ...
            if (move_uploaded_file($file_tmp, $destinationPath)) {
                ...
                $areCsGenPropertiesColumns = ['A', 'Q', 'R', 'U', 'V', 'W', 'X', 'Y', 'Z', 'AA', 'AB', 'AD', 'AE'];
                ...
                $AreIcsGenPropertiesSql = "INSERT INTO are_ics_gen_properties (propertyID, dateReceived, soQty, soValue, previousCondition, location, currentCondition, dateOfPhysicalInventory, airemarks, supplier, POnumber, AIRNumber, notes, jevNo) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
