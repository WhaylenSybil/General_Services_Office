  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1><i class="fa fa archive"></i>Property Return Slip (PRS) & Waster Material Report (WMR) Master Lists</h1>
        <ol class="breadcrumb">
          <li><a href="dashboard.php"><i class="fa fa-dashboard">PRS/WMR Reports</i></a></li>
        </ol>
      </section>
      ...
      <section class="content container-fluid">
        <div class="box">
          ...
          <div class="box-body">
            <div class="row">
              <a href="WMRmasterList.php">
                <div class="col-md-4 col-sm-6 col-sx-12">
                  <div class="info-box">
                    <span class="info-box-icon bg-red"><i class="fa fa-print"></i></span>
                    <div class="info-box-content">
                      <span class="info-box-number"> Waster Material Report (WMR) Master List</span>
                      <a href="WMRmasterList.php" class="small-box-footer"></a>
