...
function displayItemWithAccessories($item) {
    ...
    <tr>
        ...
        <td>
            <?php 
                // Check if both gpremarks and airemarks are set
                if (isset($item["gpremarks"]) && isset($item["airemarks"])) {
                    // Display both gpremarks and airemarks separated by a semicolon
                    echo $item["gpremarks"] . " ; " . $item["airemarks"];
                } else {
                    // Check if gpremarks is set and display it
                    echo isset($item["gpremarks"]) ? $item["gpremarks"] : '';

                    // Check if airemarks is set and display it
                    if (isset($item["airemarks"])) {
                        // Add a semicolon if gpremarks is set and airemarks is set
                        echo isset($item["gpremarks"]) ? " ; " : ''; 
                        echo $item["airemarks"];
                    }
                }
            ?>
