...
function displayItemWithAccessories($item) {
    ...
    <tr>
        <td>
            ...
            $scannedICSPath = $item["scannedDocs"];
            if (!empty($scannedICSPath)) {
                ...
                echo ''; // Empty link if scannedICS is null
            }
            ?>
        </td>
        ...
        <td>
            <a href="manageInactiveSemiPPETableEdit.php?propertyID=<?php echo $item['propertyID']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
        </td>
