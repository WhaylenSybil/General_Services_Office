...
<head>
    ...
    <?php
           ...
           if (isset($_GET['accountNumber'])) {
               $account = urldecode($_GET['accountNumber']);
               echo "<title style='text-align: center;'>Account: $account</title>";
           } else {
               echo "<title>ICS Properties By Accountable Person Report</title>";
           }
       ?>
    ...
    <style>
        ...
        #ICSperAccountTable th{
            text-align: center;
        }
        #ICSperAccountTable td{
            text-align: center;
        }
        @media print{
            $ICSperAccountTable th{
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#ICSperAccountTable').DataTable({
                dom: 'Bfrtip',
                buttons: [
                    {
                        extend: 'print',
    ...
    if (isset($_GET['accountNumber'])) {
        ...
        if ($stmt) {
            ...
            if ($result->num_rows > 0) {
                echo "<h3 id='printTitle' style='text-align: center; line-height: 2em;'>Report on Physical Count of Semi-Expendable Property, Plant, and Equipment<br>Account: <span style='text-decoration: underline;'>$account</span></h3>";

                // Display the table
                echo "<div class = 'table-responsive'>";
                echo "<div style ='max-height:200%; overflow-y:auto;'>";
                echo "<table id='ICSperAccountTable' class='table table-bordered table-striped'>";
                echo "<thead>
                        <tr>
                ...
                echo "No ICS properties found for Account: $account";
            }
        ...
        echo "Account parameter not provided.";
    }
    ?>
    </div>
</body>
