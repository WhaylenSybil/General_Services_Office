...
<div class="col-md-12"><!-- Group 1 -->
  <div class="form-group">
    <h4 class="box-title" align="center"><b>EDIT ARE-ISSUED PPE</b></h4>
...
<div class="col-md-3">
  <div class="form-group">
    ...
    <input list="rescenter_options" class="form-control" id="officeName" placeholder="Responsibility Center" name="officeName" autocomplete="off" value="<?php echo $row['officeName']; ?>">
  ...
  <table class="table table-bordered" id="dynamicFields">
    ...
    <tbody>
      <tr>
        ...
        <td><input type="text" class="form-control" name="AREno[]" autocomplete="off" value="<?php echo $row['AREno']; ?>"></td>
