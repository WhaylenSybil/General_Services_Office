...
function displayItemWithAccessories($item) {
    ...
    <tr>
        ...
        <td><?php echo isset($item["brand"]) ? $item["brand"] : '';?></td>
        <td><?php echo isset($item["serialNo"]) ? $item["serialNo"] : '';?></td>
        <td><?php echo isset($item["particulars"]) ? $item["particulars"] : '';?></td>
        ...
        <td style="white-space: nowrap;"><?php echo isset($item["officeName"]) ? $item["officeName"] : ''; ?></td>
        ...
        <td>
            <a href="manageActivePPETableEdit.php?propertyID=<?php echo $item['propertyID']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
        </td>
